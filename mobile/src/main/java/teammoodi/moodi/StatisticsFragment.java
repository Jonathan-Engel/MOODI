 ...
 * {@link StatisticsFragment.OnStatisticsFragmentInteractionListener} interface
...
public class StatisticsFragment extends Fragment {
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onStatisticsFragmentInteraction(uri);
        }
    }
    ...
    public interface OnStatisticsFragmentInteractionListener {
        ...
        void onStatisticsFragmentInteraction(Uri uri);
    }
}
